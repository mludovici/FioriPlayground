			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mainapp-display": {
								"semanticObject": "mainapp",
								"action": "display",
								"description": "An app to test out things",
								"title": "Playground App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mainapp",
									"url": sap.ui.require.toUrl("mainapp")
								}
							}
						}
					}
